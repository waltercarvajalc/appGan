<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <x-button target="" href="{{ route('animals.create') }}" variant="black"
                class="justify-center max-w-xs gap-2">
                <x-icons.create class="w-6 h-6" aria-hidden="true" />
                <span>Crear Animal</span>
            </x-button>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        ...
        <div class="relative overflow-x-auto">
            @if(session('success'))
            <div id="" class=" text-white p-4 rounded mb-4">
                {{ session('success') }}
            </div>
            @endif
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <img src="/storage/{{ $animal->image}}" width="50" alt="{{ $animal->name }}"
                                class="rounded">
                        </td>
                        <td class="px-6 py-4">
