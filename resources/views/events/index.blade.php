<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <x-button target="" href="{{ route('events.create') }}" variant="black"
            ...
            @if(session('success'))
            <div id="notification" class="fixed top-4 right-4 bg-green-500 text-white py-2 px-4 rounded shadow-lg">
                {{ session('success') }}
            </div>
            @endif
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b border-gray-200">{{ $event->animal->name }}</td>
