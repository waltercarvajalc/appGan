<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-md rounded my-6 p-6">
            @if(session('success'))
            <div id="notification" class="bg-green-400 text-white p-4 rounded mb-4">
                {{ session('success') }}
            </div>
            @endif
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        <td class="py-2 px-4 border-b border-gray-200">{{ $treatment->animal->name }}</td>
                        <td class="py-2 px-4 border-b border-gray-200">{{ $treatment->date }}</td>
                        <td class="py-2 px-4 border-b border-gray-200">{{ $treatment->detail }}</td>
                            ...
                            <a href="{{ route('treatments.edit', $treatment->id) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-400" fill="none"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a22 0 112.8282.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>
                        </td>
                        <td class="py-2 px-4 border-b border-gray-200">
